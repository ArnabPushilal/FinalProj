...
#  
 model=model_ob(3705,256,45276,8450,488)

#   try:
#     isinstance(model_ob(1,1,1,False),MF) 
#     model=model_ob(3705,45276,256,bias=False)
#   except:
#     model=model_ob(3705,256,45276,8450)
 ...
 test.to_csv(f'result_df_short/{model_name}.csv')
...
if __name__=='__main__':
    ...
    # run('new_data_short/train_1.csv','new_data_short/val_1.csv',\
    #     'new_data_short/test_1.csv',NeuralCF_h,train_CF,test_model_CF,'self_attention_1',0.001,8)
    ...
    # run('new_data_short/train_1.csv','new_data_short/val_1.csv',\
    #     'new_data_short/test_1.csv',NeuralCF_new_self_with_recipe_att,train_CF,test_model_CF,'self_attention_1_with_recipe',0.001,10)
    ...
    # run('new_data_short/train_1.csv','new_data_short/val_1.csv',\
    #     'new_data_short/test_1.csv',NeuralCF_2,train_CF_2,test_model_CF,'CF_basic_1',0.001,8)
    ...
    # run('new_data_short/train_1.csv','new_data_short/val_1.csv',\
    #     'new_data_short/test_1.csv',NeuralCF_og,train_CF,test_model_CF,'CF_og_1',0.001,8)
    ...
    # run('new_data_short/train_1.csv','new_data_short/val_1.csv',\
    #     'new_data_short/test_1.csv',MF,train_MF,test_model_MF,'MF_bias_false_1',0.001,10)
    ...
    # run('new_data_short/train_1.csv','new_data_short/val_1.csv',\
    #     'new_data_short/test_1.csv',NeuralCF_low_without_recipe,train_CF,test_model_CF,'att_paper_no_recipe_1',0.001,8)

    # run('new_data_short/train_2.csv','new_data_short/val_2.csv',\
    #     'new_data_short/test_2.csv',NeuralCF_low_without_recipe,train_CF,test_model_CF,'att_paper_no_recipe_2',0.001,8)

    # run('new_data_short/train_3.csv','new_data_short/val_3.csv',\
    #     'new_data_short/test_3.csv',NeuralCF_low_without_recipe,train_CF,test_model_CF,'att_paper_no_recipe_3',0.001,8)

    # run('new_data_short/train_1.csv','new_data_short/val_1.csv',\
    #     'new_data_short/test_1.csv',NeuralCF_low,train_CF,test_model_CF,'att_paper_with_recipe_1',0.001,8)
